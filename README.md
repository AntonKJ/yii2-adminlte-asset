...
[![Latest Stable Version](https://poser.pugx.org/antonkj/yii2-adminlte-asset/v/stable.svg)](https://packagist.org/packages/antonkj/yii2-adminlte-asset) 
[![Total Downloads](https://poser.pugx.org/antonkj/yii2-adminlte-asset/downloads.svg)](https://packagist.org/packages/antonkj/yii2-adminlte-asset)
[![License](https://poser.pugx.org/antonkj/yii2-adminlte-asset/license.svg)](https://packagist.org/packages/antonkj/yii2-adminlte-asset)
...
```
composer require antonkj/yii2-adminlte-asset "^2.1"
```

To install AdminLTE v1 run:

```
composer require antonkj/yii2-adminlte-asset "^1"
```
...
For details see [#140](https://github.com/antonkj/yii2-adminlte-asset/issues/140).
...
- For issues with `DmitryBaranovskiy/eve.git`, please see [#128](https://github.com/antonkj/yii2-adminlte-asset/issues/128#issuecomment-361895922) and [#113](https://github.com/antonkj/yii2-adminlte-asset/issues/133#issuecomment-337179853).
...
> For other [issues](https://github.com/antonkj/yii2-adminlte-asset/issues?utf8=%E2%9C%93&q=is%3Aissue), please search GitHub first.
...
'components' => [
    'view' => [
         'theme' => [
             'pathMap' => [
                '@app/views' => '@vendor/antonkj/yii2-adminlte-asset/example-views/yiisoft/yii2-app'
             ],
         ],
    ],
],
...
For [phd5](https://github.com/antonkj/phd5-app) application
...
'components' => [
    'view' => [
        'theme' => [
            'pathMap' => [
                '@app/views' => '@vendor/antonkj/yii2-adminlte-asset/example-views/testing/app'
            ],
        ],
    ],
],
...
- Copy files from `vendor/antonkj/yii2-adminlte-asset/example-views/yiisoft/yii2-app` (or other theme) to `@app/views`.
...
```html
<body class="<?= \antonkj\helpers\AdminLteHelper::skinClass() ?>">
```
    ...
    $config['modules']['gii'] = [
        ...
        'generators' => [ //here
            'crud' => [
                ...
                'templates' => [
                    'adminlte' => '@vendor/antonkj/yii2-adminlte-asset/gii/templates/crud/simple',
                ]
            ]
        ],
    ];
...
> Namespacing rules follow the Yii 2.0 framework structure, eg. `antonkj\web` for the Asset Bundle.
